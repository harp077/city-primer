...
import city.em.CityFacade;
import city.util.JsfUtil;
import city.util.JsfUtil.PersistAction;
...
public class CityController implements Serializable {
    ...
    @Inject
    private city.em.CityFacade ejbFacade;
    ...
    public City getCity(java.lang.Long id) {
